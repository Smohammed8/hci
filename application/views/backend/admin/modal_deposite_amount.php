	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body" style="">
               ...
               <?php echo form_open(base_url() . 'index.php?admin/deposit_amount/deposit/', array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top','name'=>'addem', 'enctype' => 'multipart/form-data'));?>
		       
			
				 
							     <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo get_phrase('Date_of_service');?>:</label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" readonly name=""  size="20" maxlength="10" value="<?php echo $row['Date_of_service'];?>" onFocus="this.blur();"  >
                                </div>
                            </div>
								   <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo get_phrase('mrn_id');?>:</label>
                                <div class="col-sm-5">
							  
                                    <input type="text" class="form-control" readonly name="mrn_id"  size="20" maxlength="10" value="<?php echo $row['mrn_id'];?>" onFocus="this.blur();"  >
                                  </div>
                            </div>
							
								   <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo get_phrase('encounter_id');?>:</label>
                                <div class="col-sm-5">
							  
                                    <input type="text" class="form-control" readonly name="encounter_id"  size="20" maxlength="10" value="<?php echo $row['encounter_id'];?>" onFocus="this.blur();"  >
                                  </div>
                            </div>
							
                            
							   <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo get_phrase('deposit_amount');?>:</label>
                                <div class="col-sm-5">
                                    <input type="number" class="form-control" name="Bed_fee" value=""   required/>
                                </div>.00
                            </div>
