	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'index.php?admin/woredas/revoke/' . $row['district_id'] , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
				 	       ...
				 	       <div class="form-group">
						<label for="field-2" style="font-weight:bold;color:black;" class="col-sm-3 control-label"><?php echo get_phrase('master_list_permission');?>:</label>
                        
						<div class="col-sm-5">
							<select name="permission" style="color:red;" class="form-control" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>">
                         <option value="">..............</option>
						      <option value="0"><?php echo get_phrase('revoke_master_list');?></option>
                          </select>
                    ...
                    <div class="form-group">
						<div class="col-sm-offset-3 col-sm-5">
							<button type="submit" class="btn btn-primary pull-right"><?php echo get_phrase('revoke');?></button>
						</div>
					</div>
                <?php echo form_close();?>
            </div>
