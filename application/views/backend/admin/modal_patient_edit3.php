	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'index.php?admin/student/'.$row['class_id'].'/editing/'.$row['mrn_id'] , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
				...
				<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" readonly name="mrn_id" value="<?php echo $row['mrn_id'];?>" data-start-view="2">
						</div> 
					</div>
					...
					<div class="form-group">
						...
						<div class="form-group">
						<label for="field-2" class="col-sm-3 control-label"><?php echo get_phrase('address_or_kebele');?></label>
