...
if(($yyyy == $yyyy2) and ($mm == $mm2) and $dd >=$dd2){
...
<span><b>Request for:</b> &nbsp;&nbsp;Custom Report&nbsp;<b> Report type:</b> <u><?php echo 'Time Interval';?></u></span>&nbsp;&nbsp;
<span><b>Start <?php echo get_phrase('year');?>:</b>&nbsp;&nbsp; &nbsp; <u><?php echo $yyyy;?> E.C</u></span>&nbsp;&nbsp;
<span><b><?php echo get_phrase('district/organization');?>:</b>&nbsp;&nbsp; All &nbsp; <u><?php echo $this->crud_model->get_woreda_name_by_id($woreda_id,$section_id);?></u>&nbsp;&nbsp;&nbsp;<b>Agreement:</b>&nbsp;&nbsp; All<u><?php echo $ag;?></u>&nbsp;&nbsp;&nbsp;&nbsp;<b>Range:</b>  From <u><?php echo $fro; ?></u> &nbsp;to&nbsp;<u><?php echo $too;?></u>&nbsp;E.C </span><br>
         ...
         <div class="" style="overflow-y:auto;" class="page" data-size="A4">
                       ...
                       <th><div><?php echo get_phrase('CBHI Code');?></div></th>
						  <th><div><?php echo get_phrase('name');?></div></th>
						    ...
						    <th><div><?php echo get_phrase('age');?></div></th>
							 ...
							 <th><div> Service <?php echo get_phrase('date');?></div></th>
			...
			<?php
			       $count = 1;
                   $sql="SELECT * from treatment where Date_of_service BETWEEN '$from' and  '$to'";
							    ...
							    <td><?php echo $row2['Date_of_service'];?> </td>
								 ...
								 <?php  }
								   ...
								   <td style="text-align: right;" width=""><?php echo $row2['other'];?></td>
								    ...
								    <?php   $sql2 = mysql_query("update treatment set total =$subtotal  where Date_of_service BETWEEN '$from' and  '$to'"); ?>
		...
		<td  colspan="11" style="text-align:right;"><b>#<?php echo get_phrase('subtotal_amount(in ETB)');?>:</b></td>
            ...
            <?php
    		$result1 = mysql_query("SELECT sum(card) FROM treatment where Date_of_service BETWEEN '$from' and  '$to'") or die(mysql_error());
    	...
    	?>
		 ...
		 <?php
    		$result2 = mysql_query("SELECT sum(lab) FROM treatment where Date_of_service BETWEEN '$from' and  '$to'") or die(mysql_error());
    	...
    	?>
		    ...
		    <td style="background-color:gray;text-align: right;" > <b>
			 ...
			 <?php
    		$result3 = mysql_query("SELECT sum(Imaging) FROM treatment where Date_of_service BETWEEN '$from' and  '$to'") or die(mysql_error());
    	...
    	?>
			 ...
			 <?php
    		$result4 = mysql_query("SELECT sum(surgery) FROM treatment where Date_of_service BETWEEN '$from' and  '$to'") or die(mysql_error());
    	...
    	?>
		  ...
		  <td style="background-color:gray;text-align: right;" > <b>
			 ...
			 <?php
    		$result5 = mysql_query("SELECT sum(drugs) FROM treatment where Date_of_service BETWEEN '$from' and  '$to'") or die(mysql_error());
    	...
    	?>    
		  <td style="background-color:gray;text-align: right;" > <b>
			 ...
			 <?php  echo number_format($drugs2,2); ?></u> </b> </td>
					 ...
					 <?php
    		$result6 = mysql_query("SELECT sum(Bed_fee) FROM treatment where Date_of_service BETWEEN '$from' and  '$to'") or die(mysql_error());
    	...
    	?>	   
		     <td style="background-color:gray;text-align: right;" > <b>
			   ...
			   <?php  echo number_format($Bed_fee2,2); ?></u> </b> </td>			   
									 	 ...
									 	 <?php
    		$result7 = mysql_query("SELECT sum(other) FROM treatment where Date_of_service BETWEEN '$from' and '$to'") or die(mysql_error());
    	...
    	?>
		   ...
		   <td style="background-color:gray;text-align: right;" > <b>
			 ...
			 <?php
    		$result8 = mysql_query("SELECT sum(total) FROM treatment where Date_of_service BETWEEN '$from' and  '$to'") or die(mysql_error());
