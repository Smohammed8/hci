...
<div class="row" style="background-color:#ccdbdc;">
	<div class="col-md-12">
		...
		<ul class="nav nav-tabs bordered" >
			...
			<li class="active">
			<img src="<?php echo $this->crud_model->get_image_url('student' , $row['mrn_id']);?>" width="100px" height="90px"  id="pro" class="profile-user-img" border="3px" >&nbsp;&nbsp;&nbsp;<b><u style="font-size:15px;"><?php echo ucwords(strtolower($row['name']));?></u></b><br>
							...
							<div class="form-group"  style="height:14px">
                                ...
                                <div class="col-sm-5">
								  ...
								  <div class="col-sm-5">
									...
									<span ><b>:</b>&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" style="font-wieght:bold;color:green !important;"><u><b><?php echo 'Check Patient Insurance book';?></b></u></a>&nbsp;&nbsp; <b><i class="fa fa-hand-o-left"></i> </b></span>
                                </div>
								
				               <?php }else{?>
                              <div class="col-sm-5">
                                 
									<b>: </b><span style="color: #dd4b39 !important;" id="blinker"> </b>&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" style="color: #dd4b39 !important;"><u><b><?php echo 'Check Patient Insurance book';?> ! </b></u></a></span>
                                </div>						   
				                    <?php }?>
                            </div>
								<?php }?>
 ...
 <!--<i class="fa  fa-users"></i>  &nbsp;&nbsp;<?php //echo get_phrase('family');?> -->
		   ...
		   <?php	 $sqlx="SELECT * FROM  patients where cbhi ='familycode' and mrn_id !='$mrn'";
                    ...
                    <tbody>
                    	...
                    	<?php $count = 1;
						 ...
						 $sqlx="SELECT * FROM  patients where cbhi ='familycode' and mrn_id !='$mrn'";
                      $resultx = mysql_query($sqlx) or die(mysql_error());
						...
						// echo'<div style="color:red;font-size:14px;" ><img src="uploads/invalid.PNG" width="17px" height="17px"/>&nbsp; No family registered yet!</div>';
	                          // echo'<div style="color:red;font-size:12px;" >  <i class="fa  fa-info-circle"></i> <strong> Within 10 days, two or more encouter creation not allowed!</strong> </div>';
    		          ...
    		          while ($rowm = mysql_fetch_array($res)) {
                        ...
                        <tr>
							...
							<td style="text-align: right;" > 
			                 <?php  echo number_format($totalx,2);?></td>	 
                ...
                <div class="box-content padded" >
                    ...
                    <thead>
                        <tr class="header-tr" bgcolor="lightblue" height="30px;">
							...
							<th><div> <?php  if($rows['agreement']=='CB Health Insurance'){ echo "CBHI Code"; } else{ echo "Patient Code"; } ?></div></th>
										...
										<?php  $indigent = $row['indigent'];?>
										  ...
										  <?php if($outcome !=''){?>
										    ...
										    <?php }
										      ...
										      <a href="#" onclick="">
                                            	<i class="entypo-user"></i>
													<del><?php echo get_phrase('outcome');?></del>
                                               	</a>
										      <?php }?>
                                              </li>
                                              ...
                                              <?php if(($outcome =='') and ($indigent=='Letter' or $indigent=='Employee' or $indigent=='Prisoner' or $indigent=='Refuge' or $indigent=='Student')){?>
                                        	 <li class="divider"></li>
												      <li>
                                           ...
                                           <li>
										    ...
										    <?php }else{?>
														<a href="#" onclick="">
                                            	<i class="entypo-pencil"></i>
													<del><?php echo get_phrase('edit');?>(<?php echo $row2['edited'];?> times edited )</del>
                                               	 </a>
									        <?php }?>
                                        </li>
