...
function generateRow($user){
	...
	$sql="SELECT * FROM `treatment`  where paid='No' and user='$user'";
                   $result=mysql_query($sql) or die(mysql_error());
                        if(mysql_num_rows($result)<1)
                           {
	             
						 echo'<div style="color:red;font-size:17px;" >
						 <img src="uploads/invalid.PNG" width="17px" height="17px"/>&nbsp; No unpaid service charge found!</div>';
						   exit;
...
// P =portriat   L=landscape
    ...
    $pdf->SetTitle('All my daily encounter report');  
    ...
    $content .= '
      	...
      	<h2 align="center"> All my encounter report from [<u>'.$date.'</u> upto <u>'.$new.'</u> ]</h2>
    ...
    $content .=generateRow($current_user) ; 
    ...
    $pdf->Output('All my daily encounter report.pdf', 'I');
