     ...
     <!-- logo -->
        ...
        <div class="logo" style="">
           <center>  <a href="#"> <img src="uploads/1215.jpg"  style="max-height:70px;width:70px;"/> 
			...
			<center><small> Welcome to Integrated HCI System </small></center> </span> 
            ...
            <a href="">
			   ...
			   <ul>
                ...
                <li class="<?php if ($page_name == 'active_user_list') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/activer_users">
            ...
            <ul>
                ...
                <li class="<?php if ($page_name == 'section') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/section">
					   ...
					   <li class="<?php if ($page_name == 'section') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/woreda">
