                ...
                <div class="box-content padded">
                   ...
                   $result=mysql_query($sql) or die(mysql_error());
                        if(mysql_num_rows($result)<1)
						 ...
						 echo'<div style="color:red;font-size:12px;" >  <i class="fa  fa-info-circle"></i> <strong> Within 10 days, two or more new encouter creation is not permitted!</strong> </div>';
