...
function generateRow($class_id,$section_id,$woreda_id,$kebele){
		$contents = '';
	 	
	$sql="SELECT * FROM `beneficiary` where woreda='$woreda_id' and region ='$class_id ' and zone='$section_id' and kebele='$kebele'";
...
// P =portriat   L=landscape
    ...
    $content .= '
      	...
      	<h2 align="center"> List of Benficiary(Abawora) in our Woreda ,'.$kebele.' Kebele  </h2>
    ...
    $content .=generateRow($class_id,$section_id,$woreda_id,$kebele) ; 
