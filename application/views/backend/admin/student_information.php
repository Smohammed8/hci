...
<br><br>
<h3> <i class="fa fa-flag"></i> <u><?php echo $this->crud_model->get_type_name_by_id('class',$class_id);?> Regional State </u></h3>
                    ...
                    <ul class="dropdown-menu dropdown-default pull-right" style="background-color:lightblue" role="menu">
                        ...
                        <li>
							...
							<li class="divider"></li>
							 ...
							 <li>
                            <a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/modal_family_profile/<?php echo $row['mrn_id'];?>');">
                                <i class="fa fa-users"></i>
                                       <?php echo get_phrase('family');?>
                                </a>
                               </li>
						    <li class="divider"></li>
								<?php }?>
                            ...
                            <a href="<?php echo base_url();?>index.php?admin/report_sheet/<?php echo $row['mrn_id'];?>">
                                <i class="entypo-print"></i>
                                    <?php echo get_phrase('medical_history');?> 
                                </a>
                        </li>
						    <li class="divider"></li>
