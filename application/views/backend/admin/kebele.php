...
tr:nth-child(even) {
  background-color: #f2f2f2;
             ...
             <table class="hoverTable" id="table_export">
                    ...
                    <tbody >
                        <?php
							   ...
							   $kebele   =   $this->db->get('kebele')->result_array();  
														   
						   foreach($kebele as $row):?>
                            <tr>
							<td><?php echo $row['kebele_code'];?> </td>
                            <td style="background-color:lightblue;"><?php echo $row['name'];?></td>
				           <td><?php echo $this->crud_model->get_woreda_name_by_id($row['woreda_id'],$row['zone_id']);?></td>
				          <td><?php echo $this->crud_model->get_section_name_by_id($row['zone_id'],$row['region_id']);?></td>
            ...
            <!-- EDITING LINK -->
		                                    ...
		                                    <!-- DELETION LINK -->
		                                    <li>
		                                        <a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?admin/kebele/delete/<?php echo $row['kebele_id'];?>');">
