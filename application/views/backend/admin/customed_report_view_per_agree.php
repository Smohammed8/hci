...
<span><b><?php echo get_phrase('district/organization');?>: All</b>&nbsp;&nbsp; &nbsp; <u><?php echo $this->crud_model->get_woreda_name_by_id($woreda_id,$section_id);?></u>&nbsp;&nbsp;&nbsp;<b>Report type: Custom</b>&nbsp;&nbsp;<u><?php echo $ag;?></u>&nbsp;&nbsp;&nbsp;&nbsp;<b>Request for:</b>  From <u><?php echo $fro; ?></u> &nbsp;to&nbsp;<u><?php echo $too;?></u>&nbsp;E.C &nbsp;&nbsp;<b>Agreement </b>&nbsp;&nbsp: <u> <?php echo $agreement;?> </u></span><br>
	    ...
	    //where month='$mm ' and agreement ='$ag' and region='$class_id' and  zone='$section_id' and woreda='$woreda_id' and year='$yyyy'
					$count = 1;
                   $sql="SELECT * from treatment where Date_of_service BETWEEN CAST('$from' AS DATE) and CAST('$to' AS DATE)  and agreement='$agreement'";
                   $result=mysql_query($sql) or die(mysql_error());
                        if(mysql_num_rows($result)<1){
	             
						 echo'<div style="color:red;font-size:17px;" ><img src="uploads/invalid.PNG" width="17px" height="17px"/>&nbsp; No report on this time interval!</div>';
	                      $this->session->set_flashdata('flash_message' , get_phrase('no_report_on_this_time_interval_per_agreement'));
						  redirect(base_url() . 'index.php?admin/customed_report/', 'refresh');
                              }
							    ...
							    <td><?php echo $row2['Date_of_service'];?> </td>
								 ...
								 <?php  }
								   ...
								   <td style="text-align: right;" width=""><?php echo $row2['other'];?></td>
								    ...
								    <?php   $sql2 = mysql_query("update treatment set total =$subtotal  where Date_of_service BETWEEN CAST('$from' AS DATE) and CAST('$to' AS DATE)  and agreement='$agreement'"); ?>
		...
		<td  colspan="11" style="text-align:right;"><b>#<?php echo get_phrase('subtotal_amount(in ETB)');?>:</b></td>
            ...
            <?php
    		$result1 = mysql_query("SELECT sum(card) FROM treatment where Date_of_service BETWEEN  CAST('$from' AS DATE) and CAST('$to' AS DATE)  and agreement='$agreement'") or die(mysql_error());
    	...
    	?>
		 ...
		 <?php
    		$result2 = mysql_query("SELECT sum(lab) FROM treatment where Date_of_service BETWEEN CAST('$from' AS DATE) and CAST('$to' AS DATE)  and agreement='$agreement'") or die(mysql_error());
    	...
    	?>
		    ...
		    <td style="background-color:gray;text-align: right;" > <b>
			 ...
			 <?php
    		$result3 = mysql_query("SELECT sum(Imaging) FROM treatment where Date_of_service BETWEEN CAST('$from' AS DATE) and CAST('$to' AS DATE) and agreement='$agreement'") or die(mysql_error());
    	...
    	?>
			 ...
			 <?php
    		$result4 = mysql_query("SELECT sum(surgery) FROM treatment where Date_of_service BETWEEN CAST('$from' AS DATE) and CAST('$to' AS DATE) and agreement='$agreement'") or die(mysql_error());
    	...
    	?>
		  ...
		  <td style="background-color:gray;text-align: right;" > <b>
			 ...
			 <?php
    		$result5 = mysql_query("SELECT sum(drugs) FROM treatment where Date_of_service BETWEEN CAST('$from' AS DATE) and CAST('$to' AS DATE) and agreement='$agreement'") or die(mysql_error());
    	...
    	?>    
		  <td style="background-color:gray;text-align: right;" > <b>
			 ...
			 <?php  echo number_format($drugs2,2); ?></u> </b> </td>
					 ...
					 <?php
    		$result6 = mysql_query("SELECT sum(Bed_fee) FROM treatment where Date_of_service BETWEEN CAST('$from' AS DATE) and CAST('$to' AS DATE) and agreement='$agreement'") or die(mysql_error());
    	...
    	?>	   
		     <td style="background-color:gray;text-align: right;" > <b>
			   ...
			   <?php  echo number_format($Bed_fee2,2); ?></u> </b> </td>			   
									 	 ...
									 	 <?php
    		$result7 = mysql_query("SELECT sum(other) FROM treatment where Date_of_service BETWEEN CAST('$from' AS DATE) and CAST('$to' AS DATE) and agreement='$agreement'") or die(mysql_error());
    	...
    	?>
		   ...
		   <td style="background-color:gray;text-align: right;" > <b>
			 ...
			 <?php
    		$result8 = mysql_query("SELECT sum(total) FROM treatment where Date_of_service BETWEEN CAST('$from' AS DATE) and CAST('$to' AS DATE) and agreement='$agreement'") or die(mysql_error());
