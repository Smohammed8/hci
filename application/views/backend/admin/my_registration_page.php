  ...
  background-color: #f2f2f2;
	...
	<hr>	
		...
		<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">		
		   ...
		   <a href="<?php echo base_url(); ?>index.php?admin/today_my_patients_print_pdf/"  class="btn btn-primary pull-right">
        <i class="entypo-print"></i> Export PDF 
...
?>
<h4> <i class="fa fa-users"></i> Patients those who are recorded by <u> <?php echo  $name;?></u> on today, <?php echo  $new;?></h4>
<table class="hoverTable" id="table_export">
        ...
        <tr class="header-tr" bgcolor="lightblue" height="30px;">
            <th><div><?php echo get_phrase('MRN');?></div></th>
	          ...
	          <th><div><?php echo get_phrase('indigent');?></div></th>
		  	  <th><div><?php echo get_phrase('date');?> (Today) </div></th>
    ...
    <tbody>
			...
			<?php
                ...
                $sqr	=	$this->db->get_where('patients' , array('user'=>$admin_id, 'cdate'=>$new))->result_array();
                foreach($sqr as $row):?>
			  <?php	$level = $row['section_id'];?>
           <tr>
                        ...
                        <li>
                            ...
                            <a href="<?php echo base_url();?>index.php?admin/report_sheet/<?php echo $row['mrn_id'];?>">
                                <i class="entypo-print"></i>
                                   Service charge history <?php //echo get_phrase('medical_history');?> 
                                </a>
                        </li>
						    <li class="divider"></li>
	...
	<label for="" class="col-sm-2 control-label"><b>Filter data by:</b></label>
		  ...
		  <?php //echo form_open(base_url().'index.php?admin/patient_info/filter/' . $row['class_id'] , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
             <form action="<?php echo base_url(); ?>index.php?admin/my_patients/<?php echo $row['class_id'];?>" method="post">    
			<div class="col-sm-2">
         ...
         <div class="form-group">
				   ...
				   <div class="col-sm-2">
			 <button type="submit" class="btn btn-primary" style="font-weight:bold;" name="search"><i class="fa fa-users"></i> <?php echo get_phrase('search');?></button> 
             </div>
	 </div>					 
