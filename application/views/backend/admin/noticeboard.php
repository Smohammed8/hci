           ...
           <table class="hoverTable" id="table_export">
                	<thead>
                		<tr class="header-tr" bgcolor="lightblue" height="30px;">
							...
							<th><div><?php echo get_phrase('posted_by');?></div></th>
	 ...
	 <?php endforeach; ?>
                        ...
                        <tr>
							...
							<td><?php echo date('d M,Y', $row['create_timestamp']);?></td>
							 ...
							 <td><?php echo $this->crud_model->get_type_name_by_id('admin',$row['user']);?></td>
							<td>
							<?php  $user = $row['user'];?>
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                	<?php echo form_open(base_url() . 'index.php?admin/noticeboard/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                          ...
                          <input type="hidden" class="form-control" name="user" value="<?php echo $current_user;?>"/>
