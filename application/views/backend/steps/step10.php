...
<html lang="en">
        ...
        <div class="login-container">
            ...
            <div class="login-form">
                ...
                <div class="login-content">
					...
					<?php echo form_open(base_url() . 'index.php?login/step11' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
 ...
 <div class="form-steps" style="font-size:12px;width:100%;">
							...
							In the last 7 days, how many days have you spent time with people who aren't staying with you?</p>
                       ...
                       <div class="form-group" style="width:100%; text-align:left;">
								...
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								 ...
								 <input type="radio" style="margin-right:0px;" value ="Yes" name="days" required />&nbsp;&nbsp;0 days <br>
							    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						          <input type="radio" style="margin-right:0px;" value ="No" name ="days" style="">&nbsp;&nbsp; 1 day<br>

	                           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						          <input type="radio" style="margin-right:0px;" value ="No" name ="days" style="">&nbsp;&nbsp;2-4 days <br>
								  
								         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						          <input type="radio" style="margin-right:0px;" value ="No" name ="days" style="">&nbsp;&nbsp;5-7 days <br>
