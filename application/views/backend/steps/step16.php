...
<html lang="en">
        ...
        <div class="login-container">
            ...
            <div class="login-form">
                ...
                <div class="login-content">
					...
					<?php echo form_open(base_url() . 'index.php?login/step17' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
 ...
 <div class="form-steps" style="font-size:12px;width:100%;">
						...
						Which of these best describes the area you are staying in?</p>
             ...
             <div class="form-group" style="width:100%; text-align:left;">
								...
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								 ...
								 <input type="radio" style="margin-right:0px;" value ="Yes" name="living" required />&nbsp;&nbsp;City  <br>
							    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						          <input type="radio" style="margin-right:0px;" value ="No" name ="living" style="">&nbsp;&nbsp;Town <br>

	                           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						          <input type="radio" style="margin-right:0px;" value ="No" name ="living" style="">&nbsp;&nbsp;Rural area or country side <br>
