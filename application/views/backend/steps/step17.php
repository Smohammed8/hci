        ...
        <div class="login-container">
            ...
            <div class="login-form">
                ...
                <div class="login-content">
					...
					<?php echo form_open(base_url() . 'index.php?login/step18' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
 ...
 <div class="form-steps" style="font-size:12px;width:100%;">
             ...
             <div class="form-group" style="width:100%; text-align:left;">
								...
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								 ...
								 <input type="radio" style="margin-right:0px;" value ="Yes" name="sex" required />&nbsp;&nbsp;Male  <br>
							    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						          <input type="radio" style="margin-right:0px;" value ="No" name ="sex" style="">&nbsp;&nbsp;Female <br>

	                           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						          <input type="radio" style="margin-right:0px;" value ="No" name ="sex" style="">&nbsp;&nbsp;Prefer not to answer <br>
