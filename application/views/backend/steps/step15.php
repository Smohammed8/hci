...
<html lang="en">
        ...
        <div class="login-container">
            ...
            <div class="login-form">
                ...
                <div class="login-content">
					...
					<?php echo form_open(base_url() . 'index.php?login/step16' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
 ...
 <div class="form-steps" style="font-size:12px;width:100%;">
						...
						How worried are you about your household’s finances in the next month?</p>
             ...
             <div class="form-group" style="width:100%; text-align:left;">
								...
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								 ...
								 <input type="radio" style="margin-right:0px;" value ="Yes" name="household" required />&nbsp;&nbsp;Very worried  <br>
							    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						          <input type="radio" style="margin-right:0px;" value ="No" name ="household" style="">&nbsp;&nbsp;Somewhat worried <br>

	                           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						          <input type="radio" style="margin-right:0px;" value ="No" name ="household" style="">&nbsp;&nbsp;Not too worried <br>
								  
								   
								  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;								  
						          <input type="radio" style="margin-right:0px;" value ="No" name ="household" style="">&nbsp;&nbsp;Not worried at all
